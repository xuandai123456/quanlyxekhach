...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( oInit )
	{
		 ...
		 *    'display index' if you have hidden data sản phẩm
		 *  @dtopt API
		 *
		 *  @example
		 *    $(document).ready(function() {
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to readily specify the sản phẩm in the length drop
		 ...
		 * (i.e. "Hiển thị 1 to 10 of 57 sản phẩm") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Hiển thị _START_ to _END_ of _TOTAL_ sản phẩm
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Got a total of _TOTAL_ sản phẩm to show (_START_ to _END_)"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Hiển thị _START_ đến _END_ trong _TOTAL_",
			 ...
			 *  @type string
			 *  @default Hiển thị 0 to 0 of 0 sản phẩm
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "No sản phẩm to show"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoEmpty": "Hiển thị 0 đến 0 trong 0 ",
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ total sản phẩm)
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default Không tìm thấy sản phẩm nào
			 *
			 *  @dtopt Language
